  ...
  <body>
    ...
    <header class="header-section clearfix">
      ...
      <div class="header-right">
        ...
        <!-- User panel with welcome message or login/register links -->
      ...
      <div class="left-panel">
        ...
        <div class="song-list-wrapper" style="max-height: 690px; overflow-y: auto;">
          <div class="song-list-header">
            <button id="show-upload-btn" class="btn btn-outline-light">Upload Song</button>
            <h2>Song List</h2>
    ...
    <div class="upload-container" style="display: none" id="uploadContainer">
      ...
      <form class="upload-form" action="upload_song.php" method="POST">
        ...
        <input type="text" name="content" placeholder="https://www.youtube.com/..." required />
